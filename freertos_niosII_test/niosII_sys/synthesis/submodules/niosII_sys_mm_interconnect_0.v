...
module niosII_sys_mm_interconnect_0 (
	...
	wire  [101:0] key_s1_agent_rf_source_data;                                                        // key_s1_agent:rf_source_data -> key_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] key_s1_agent_rsp_fifo_out_data;                                                     // key_s1_agent_rsp_fifo:out_data -> key_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> key_s1_agent:cp_data
	...
	wire  [100:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire  [100:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [100:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [100:0] key_s1_agent_rp_data;                                                               // key_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [100:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [100:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [82:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [100:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [100:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_006:sink1_data
	wire          cmd_demux_001_src3_ready;                                                           // cmd_mux_006:sink1_ready -> cmd_demux_001:src3_ready
	wire    [7:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_006:sink1_channel
	...
	wire  [100:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_007:sink1_data
	wire          cmd_demux_001_src4_ready;                                                           // cmd_mux_007:sink1_ready -> cmd_demux_001:src4_ready
	wire    [7:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_007:sink1_channel
	...
	wire  [100:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink3_data
	wire          rsp_demux_006_src1_ready;                                                           // rsp_mux_001:sink3_ready -> rsp_demux_006:src1_ready
	wire    [7:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire  [100:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink4_data
	wire          rsp_demux_007_src1_ready;                                                           // rsp_mux_001:sink4_ready -> rsp_demux_007:src1_ready
	wire    [7:0] rsp_demux_007_src1_channel;                                                         // rsp_demux_007:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire   [82:0] router_008_src_data;                                                                // router_008:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [100:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	...
	wire  [100:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sdram_s1_cmd_width_adapter:in_data
